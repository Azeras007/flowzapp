...
const integrations = [
  [
    {
      id: 'integration-1',
      icon: <img alt="Integration" src="/google-calendar.svg" />,
    },
    {
      id: 'integration-2',
      icon: <img alt="Integration" src="/discord.svg" />,
    },
    {
      id: 'integration-3',
      icon: <img alt="Integration" src="/youtube.svg" />,
    },
    {
      id: 'integration-4',
      icon: <img alt="Integration" src="/gmail.svg" />,
    },
    {
      id: 'integration-5',
      icon: <img alt="Integration" src="/youtube.svg" />,
  ...
  [
    {
      id: 'integration-6',
      icon: <img alt="Integration" src="/openai.svg" />,
    },
    {
      id: 'integration-7',
      icon: <img alt="Integration" src="/github.svg" />,
    },
    {
      id: 'integration-8',
      icon: <img alt="Integration" src="/apple.svg" />,
    },
    {
      id: 'integration-9',
      icon: <img alt="Integration" src="/discord.svg" />,
    ...
    {
      id: 'integration-10',
      icon: <img alt="Integration" src="/link.svg" />,
    },
  ],
  [
    {
    ...
    {
      id: 'integration-12',
      icon: <img alt="Integration" src="/notion.svg" />,
    },
    {
      id: 'integration-13',
      icon: <img alt="Integration" src="/google-calendar.svg" />,
      ...
      <div className="relative">
        ...
        <div className="md:-space-x-26 container relative flex flex-col items-start md:flex-row md:items-center">
          <div className="z-20 -mx-[calc(theme(container.padding))] w-[calc(100%+2*theme(container.padding))] shrink-0 bg-background px-[calc(theme(container.padding))] pt-32 md:w-1/2 md:bg-transparent md:pb-32">
            <div className="flex flex-col items-start text-left pl-12">
