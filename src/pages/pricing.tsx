                            ...
                            <CardContent>
                                ...
                                <ul className="space-y-4">
                                    <li className="flex items-center gap-2">
                                        ...
                                        <span>Increased Active Workflows.</span>
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <CircleCheck className="size-4" />
                                        <span>More Frequent Workflow Executions.</span>
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <CircleCheck className="size-4" />
                        ...
                        <Card className="flex w-80 flex-col justify-between text-left">
                            ...
                            <CardContent>
                                ...
                                <ul className="space-y-4">
                                    <li className="flex items-center gap-2">
                                        <CircleCheck className="size-4" />
                                        <span>Unlimited Workflows and Actions.</span>
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <CircleCheck className="size-4" />
                                    ...
                                    <li className="flex items-center gap-2">
                                        <CircleCheck className="size-4" />
                                        <span>Detailed Workflow Analytics.</span>
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <CircleCheck className="size-4" />
